...
*
*
## 📥 Download dei Pesi dei Modelli

A causa delle dimensioni dei file (es. la baseline MLP conta ~77M di parametri), i pesi dei modelli addestrati non sono caricati su GitHub. 

Puoi scaricarli direttamente da **[QUESTA CARTELLA GOOGLE DRIVE](https://drive.google.com/drive/folders/1SVSBWlzIjtSjsbEG7F0CCkyiA2OblJRE?usp=sharing)**.

Una volta scaricati i file `.pth`, assicurati di inserirli nel percorso corretto all'interno del progetto:
`results/multiclass/`
